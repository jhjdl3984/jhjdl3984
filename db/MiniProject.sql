...
-- 내가 생각한 코드
SELECT fc.category_id, COUNT(*) AS totalcategory_id
FROM film_category fc
GROUP BY fc.category_id;

SELECT c.name, COUNT(fc.category_id) AS totalcategory_id
FROM category c
JOIN film_category fc ON c.category_id = fc.category_id
GROUP BY c.name;

-- 내가 생각한 코드
SELECT r.rental_date, c.customer_id
FROM rental r
...
SELECT c.customer_id, MAX(r.rental_date) AS last_rental_date, f.title
FROM rental r
...
SELECT a.first_name, a.last_name, COUNT(fa.actor_id) AS sum_film
FROM actor a
JOIN film_actor fa ON a.actor_id = fa.actor_id
...
SELECT c.first_name, c.last_name, COUNT(r.customer_id) AS count_rental
FROM customer c
JOIN rental r ON c.customer_id = r.customer_id
